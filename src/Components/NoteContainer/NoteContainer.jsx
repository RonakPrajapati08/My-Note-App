...
//       <div className="flex-1">
//         {/* --- START OF REDESIGNED HEADER SECTION --- */}
...
//             {/* Right Side: Actions (Search + Delete) */}
//             <div className="flex flex-1 items-center justify-end gap-3 w-full md:w-auto">
//               {/* Search Bar - Integrated Inline */}
//               <div className="relative w-full md:max-w-sm group">
//                 <FontAwesomeIcon
//                   icon={faMagnifyingGlass}
//                   className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-500 transition-colors w-4 h-4"
//                 />
//                 <input
//                   type="text"
//                   placeholder="Search notes..."
...
//               {/* Delete All Button - Premium Compact Style */}
//               {!selectedNote && (
//                 <button
//                   disabled={notes.length === 0}
//                   onClick={() => notes.length > 0 && setShowDeleteConfirm(true)}
//                   className={`
...
//                 : "bg-red-50 text-red-600 border border-red-100 hover:bg-red-100 hover:text-red-700 active:scale-95"
//             }
//           `}
//                 >
...
//           </div>
//         </header>
//         {/* --- END OF REDESIGNED HEADER SECTION --- */}
