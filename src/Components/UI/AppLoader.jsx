...
export function EmptyState({ onAdd }) {
  return (
    <div className="flex flex-col items-center justify-center py-24 px-4 text-center">
      <div className="w-20 h-20 rounded-3xl bg-indigo-50 dark:bg-indigo-900/30 flex items-center justify-center mb-6 shadow-inner">
        <svg width="36" height="36" viewBox="0 0 24 24" fill="none" className="stroke-indigo-600 dark:stroke-indigo-300" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          <path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
      </div>
      ...
      <p className="text-gray-500 dark:text-gray-400 text-sm max-w-xs leading-relaxed mb-8">
        Capture ideas, tasks, and everything in between. Your workspace is ready.
      </p>
      <button
        onClick={onAdd}
        className="inline-flex items-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-xl transition-all shadow-lg shadow-indigo-200 dark:shadow-indigo-900/40 hover:scale-[1.02] active:scale-[0.98]"
      >
